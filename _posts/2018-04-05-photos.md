...
<section>
     <section data-background="{{site.baseurl}}/images/ro.jpg">
        <h2>How to</h2>
        <pre><code class="hljs">Use the arrows to navigate (up, down, left, right) or the keyboard arrows. If you use a phone or tablet, just swipe in the arrows directions.</code></pre>
    </section>
    <section>
